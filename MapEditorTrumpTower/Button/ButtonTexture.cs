...
namespace MapEditorTrumpTower.Button
{
    public class ButtonTexture
    {
        ...
        public ButtonTexture (Game1MapEditor ctx, Texture2D textureButton, SpriteFont textShortCut, MapTexture texture, Vector2 position, string shortCut, List<Keys> keysShortCut)
        {
            Ctx = ctx;
