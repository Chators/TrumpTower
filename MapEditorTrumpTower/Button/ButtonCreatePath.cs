...
namespace MapEditorTrumpTower.Button
{
    ...
    public class ButtonCreatePath
    {
        ...
        public ButtonCreatePath(Game1 ctx, string description, Texture2D textureButton, SpriteFont textShortCut, ActionCreatePath action, Vector2 position, string shortCut, List<Keys> keysShortCut)
        {
            Ctx = ctx;
            Action = action;
