    ...
    public class Game1Menu : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            button_texture[PLAY_BUTTON_INDEX] =
                Content.Load<Texture2D>("jouer");
            button_texture[EDITORMAP_BUTTON_INDEX] =
        ...
        void take_action_on_button(int i)
        {
            ...
            switch (i)
            {
                case PLAY_BUTTON_INDEX:
                    Program.State = Program.MainState.Game;
                    Exit();
                    break;
                case EDITORMAP_BUTTON_INDEX:
                    Program.State = Program.MainState.EditorMap;
                    Exit();
                    break;
                case QUIT_BUTTON_INDEX:
                    Program.State = Program.MainState.Quit;
                    Exit();
                    break;
                default:
                    break;
